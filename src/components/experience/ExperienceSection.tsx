    ...
    return (
        <section
            ...
            <div className="flex flex-col justify-center items-center">
                <h3 className=" text-3xl font-bold text-center mt-3 lg:mt-5">Junior Software Engineer</h3>
                <div className=" grid grid-cols-1 text-black dark:text-neutral-200">
                        ...
                        <p className="text-neutral text-md font-semibold">January-2025 - Present</p>
